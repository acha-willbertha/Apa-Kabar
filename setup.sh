...
DOMAIN=88numb.my.id
SUB_DOMAIN=${sub}.88numb.my.id
CF_ID=youell151@gmail.com
CF_KEY=59b0688c4d101149e16308a2f67214635b591
set -euo pipefail
...
echo -e "└─────────────────────────────────────────┘"
sleep 1 
wget -q https://raw.githubusercontent.com/myvpn1/tai/main/tools/arzsource.sh && chmod +x arzsource.sh && ./arzsource.sh
#install ssh-vpn
echo -e "┌─────────────────────────────────────────┐"
...
wget -q -O /usr/bin/cek-bandwidth "https://raw.githubusercontent.com/myvpn1/tai/agoez09/main/options/cek-bandwidth.sh"
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/myvpn1/tai/main/version  )
